...
self-maps refused with a log; resolution is transitive with oldest-canon-birth
survivor (short slugs demoted; never lex); aliases are retroactive at retract time, never rewritten.
